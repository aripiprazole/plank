...
data class StructInfo(override val name: Identifier) : TyInfo

data class StructMemberInfo(override val name: Identifier) : TyInfo

data class EnumInfo(override val name: Identifier) : TyInfo

data class EnumMemberInfo(override val name: Identifier) : TyInfo
