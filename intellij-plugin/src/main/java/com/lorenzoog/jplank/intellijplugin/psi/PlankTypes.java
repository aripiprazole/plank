...
public interface PlankTypes {
  ...
  IElementType INSTANCE_EXPR = new PlankElementType("INSTANCE_EXPR");
  ...
  IElementType ARGUMENT = new PlankTokenType("argument");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == INSTANCE_EXPR) {
        return new PlankInstanceExprImpl(node);
      }
