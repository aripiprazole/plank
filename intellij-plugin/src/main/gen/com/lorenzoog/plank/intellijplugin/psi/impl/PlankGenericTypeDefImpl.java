...
public class PlankGenericTypeDefImpl extends ASTWrapperPsiElement implements PlankGenericTypeDef {

  public PlankGenericTypeDefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  public @NotNull PsiElement getReceiver() {
